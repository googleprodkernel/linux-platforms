...
#define VIOMMU_GUEST_MMIO_BASE1		0
#define VIOMMU_GUEST_MMIO_SIZE1		(64 * VIOMMU_MAX_GUESTID)

#define VIOMMU_CMDBUF_DIRTY_STATUS_BASE	0x400000ULL
#define VIOMMU_CMDBUF_DIRTY_STATUS_SIZE	0x2000

#define VIOMMU_GUEST_MMIO_BASE2		0x402000ULL
#define VIOMMU_GUEST_MMIO_SIZE2		0x100000
